...
SELECT current_setting('pg_flashback.runtime_retention');
SELECT current_setting('pg_flashback.recovered_wal_retention');
SELECT current_setting('pg_flashback.meta_retention');
